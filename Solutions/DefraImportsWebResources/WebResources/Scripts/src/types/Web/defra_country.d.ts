declare namespace WebApi {
  ...
  interface defra_country_Relationships {
    ...
    defraimp_defra_country_defraimp_importapplication_transporteraddresscountryid?: defraimp_importapplication_Result[] | null;
    ...
    defraimp_defra_country_defraimp_itahc_ConsigneeAddressCountryId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_ConsignorAddressCountryId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_CountryOfOriginId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_PlaceOfDestinationAddressCountryId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_PlaceOfLoadingAddressCountryId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_PlaceOfOriginHarvestAddressCountryId?: defraimp_itahc_Result[] | null;
    defraimp_defra_country_defraimp_itahc_TransporterAddressCountryId?: defraimp_itahc_Result[] | null;
  ...
  interface defra_country_Expand {
    ...
    defraimp_defra_country_defraimp_importapplication_transporteraddresscountryid: WebExpand<defra_country_Expand, defraimp_importapplication_Select, defraimp_importapplication_Filter, { defraimp_defra_country_defraimp_importapplication_transporteraddresscountryid: defraimp_importapplication_Result[] }>;
    ...
    defraimp_defra_country_defraimp_itahc_ConsigneeAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_ConsigneeAddressCountryId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_ConsignorAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_ConsignorAddressCountryId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_CountryOfOriginId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_CountryOfOriginId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_PlaceOfDestinationAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_PlaceOfDestinationAddressCountryId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_PlaceOfLoadingAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_PlaceOfLoadingAddressCountryId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_PlaceOfOriginHarvestAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_PlaceOfOriginHarvestAddressCountryId: defraimp_itahc_Result[] }>;
    defraimp_defra_country_defraimp_itahc_TransporterAddressCountryId: WebExpand<defra_country_Expand, defraimp_itahc_Select, defraimp_itahc_Filter, { defraimp_defra_country_defraimp_itahc_TransporterAddressCountryId: defraimp_itahc_Result[] }>;
  ...
  interface defra_country_RelatedMany {
    ...
    defraimp_defra_country_defraimp_itahc_ConsigneeAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_ConsignorAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_CountryOfOriginId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_PlaceOfDestinationAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_PlaceOfLoadingAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_PlaceOfOriginHarvestAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
    defraimp_defra_country_defraimp_itahc_TransporterAddressCountryId: WebMappingRetrieve<WebApi.defraimp_itahc_Select,WebApi.defraimp_itahc_Expand,WebApi.defraimp_itahc_Filter,WebApi.defraimp_itahc_Fixed,WebApi.defraimp_itahc_Result,WebApi.defraimp_itahc_FormattedResult>;
