declare namespace Form.defraimp_importapplication.Quick {
  ...
  interface QuickViewforQuery extends Xrm.PageBase<QuickViewforQuery.Attributes,QuickViewforQuery.Tabs,QuickViewforQuery.Controls> {
