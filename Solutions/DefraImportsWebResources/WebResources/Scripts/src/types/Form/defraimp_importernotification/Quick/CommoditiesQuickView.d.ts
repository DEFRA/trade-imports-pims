declare namespace Form.defraimp_importernotification.Quick {
  namespace CommoditiesQuickView {
    namespace Tabs {
  ...
  interface CommoditiesQuickView extends Xrm.PageBase<CommoditiesQuickView.Attributes,CommoditiesQuickView.Tabs,CommoditiesQuickView.Controls> {
