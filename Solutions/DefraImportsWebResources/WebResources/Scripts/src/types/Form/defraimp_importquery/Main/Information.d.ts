declare namespace Form.defraimp_importquery.Main {
  namespace Information {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "defraimp_originalquery"): Xrm.LookupControl<"defraimp_importquery">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "defraimp_originalquery"): Xrm.LookupAttribute<"defraimp_importquery">;
    ...
    getControl(controlName: "defraimp_originalquery"): Xrm.LookupControl<"defraimp_importquery">;
