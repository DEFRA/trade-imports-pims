declare namespace Form.systemuser.Main {
  namespace User {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "address2_composite"): Xrm.Attribute<string>;
      ...
      get(name: "defraexp_office"): Xrm.LookupAttribute<"defraexp_office">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "address2_composite"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_city"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_country"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_line1"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_line2"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_line3"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_postalcode"): Xrm.StringControl;
      get(name: "address2_composite_compositionLinkControl_address2_stateorprovince"): Xrm.StringControl;
      ...
      get(name: "defraexp_office"): Xrm.LookupControl<"defraexp_office">;
  ...
  interface User extends Xrm.PageBase<User.Attributes,User.Tabs,User.Controls> {
    ...
    getAttribute(attributeName: "address2_composite"): Xrm.Attribute<string>;
    ...
    getAttribute(attributeName: "defraexp_office"): Xrm.LookupAttribute<"defraexp_office">;
    ...
    getControl(controlName: "address2_composite"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_city"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_country"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_line1"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_line2"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_line3"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_postalcode"): Xrm.StringControl;
    getControl(controlName: "address2_composite_compositionLinkControl_address2_stateorprovince"): Xrm.StringControl;
    ...
    getControl(controlName: "defraexp_office"): Xrm.LookupControl<"defraexp_office">;
