declare namespace WebApi {
  interface defraimp_itahc_Base extends WebEntity {
    ...
    defraimp_complementid?: string | null;
    ...
    defraimp_passportnumber?: string | null;
    ...
    defraimp_relatedimportrecord?: boolean | null;
    defraimp_replacedreferencenumber?: string | null;
    defraimp_replacingreferencenumber?: string | null;
    defraimp_speciesclass?: string | null;
    defraimp_speciesid?: string | null;
    defraimp_speciesmodel?: string | null;
    defraimp_speciesnomination?: string | null;
    defraimp_speciestype?: string | null;
  ...
  interface defraimp_itahc_Select {
    ...
    defraimp_commodityidtypes: WebAttribute<defraimp_itahc_Select, { defraimp_commodityidtypes: string | null }, {  }>;
    ...
    defraimp_complementid: WebAttribute<defraimp_itahc_Select, { defraimp_complementid: string | null }, {  }>;
    ...
    defraimp_devolvedoffice_guid: WebAttribute<defraimp_itahc_Select, { defraimp_devolvedoffice_guid: string | null }, { defraimp_devolvedoffice_formatted?: string }>;
    defraimp_estimatedjourneytime: WebAttribute<defraimp_itahc_Select, { defraimp_estimatedjourneytime: number | null }, {  }>;
    defraimp_formattedcommoditycomplementstext: WebAttribute<defraimp_itahc_Select, { defraimp_formattedcommoditycomplementstext: string | null }, {  }>;
    defraimp_formattedidentificationofanimalstext: WebAttribute<defraimp_itahc_Select, { defraimp_formattedidentificationofanimalstext: string | null }, {  }>;
    ...
    defraimp_passportnumber: WebAttribute<defraimp_itahc_Select, { defraimp_passportnumber: string | null }, {  }>;
    ...
    defraimp_relatedimportrecord: WebAttribute<defraimp_itahc_Select, { defraimp_relatedimportrecord: boolean | null }, {  }>;
    ...
    defraimp_speciesclass: WebAttribute<defraimp_itahc_Select, { defraimp_speciesclass: string | null }, {  }>;
    defraimp_speciesid: WebAttribute<defraimp_itahc_Select, { defraimp_speciesid: string | null }, {  }>;
    defraimp_speciesmodel: WebAttribute<defraimp_itahc_Select, { defraimp_speciesmodel: string | null }, {  }>;
    defraimp_speciesnomination: WebAttribute<defraimp_itahc_Select, { defraimp_speciesnomination: string | null }, {  }>;
    defraimp_speciestype: WebAttribute<defraimp_itahc_Select, { defraimp_speciestype: string | null }, {  }>;
  ...
  interface defraimp_itahc_Filter {
    ...
    defraimp_passportnumber: string;
    ...
    defraimp_relatedimportrecord: boolean;
    ...
    defraimp_speciesclass: string;
    defraimp_speciesid: string;
    defraimp_speciesmodel: string;
    defraimp_speciesnomination: string;
    defraimp_speciestype: string;
