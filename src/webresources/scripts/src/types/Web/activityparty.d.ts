declare namespace WebApi {
  ...
  interface ActivityParty extends ActivityParty_Base, ActivityParty_Relationships {
    ...
    activityid_defraexp_additionalcheck_activityparty_bind$defraexp_additionalchecks?: string | null;
    activityid_defraimp_importquery_activityparty_bind$defraimp_importqueries?: string | null;
    ...
    partyid_defra_addressdetails_bind$defra_addressdetailses?: string | null;
    partyid_defra_invitation_bind$defra_invitations?: string | null;
    partyid_defraexp_certifierorganisation_bind$defraexp_certifierorganisations?: string | null;
...
interface WebEntitiesRetrieve {
  activityparties: WebMappingRetrieve<WebApi.ActivityParty_Select,WebApi.ActivityParty_Expand,WebApi.ActivityParty_Filter,WebApi.ActivityParty_Fixed,WebApi.ActivityParty_Result,WebApi.ActivityParty_FormattedResult>;
}
interface WebEntitiesRelated {
  activityparties: WebMappingRelated<WebApi.ActivityParty_RelatedOne,WebApi.ActivityParty_RelatedMany>;
}
interface WebEntitiesCUDA {
  activityparties: WebMappingCUDA<WebApi.ActivityParty_Create,WebApi.ActivityParty_Update,WebApi.ActivityParty_Select>;
}
