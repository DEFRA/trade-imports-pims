...
- **AC-1:** ITAHCs created in TRACES Classic are received and automatically created in PIMS within 30 minutes of the time that creation notification emails would have been received by the CIT team.

- **AC-2:** ITAHCs are automatically created in PIMS with the fields specified in the TRACES→D365 field mapping schema (now documented in the Entity Schemas workbook — see DEP-001 in [assumptions-and-constraints.md](../assumptions-and-constraints.md)).
